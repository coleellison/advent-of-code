input_text = """.854...........................................................................362...........271...732........838.........24................
...*.............................117*...........459........767*648....#.........*...................................$...&..=................
...
def digit_check(index_tuple):
    row = index_tuple[0]
    column = index_tuple[1]
    numeric_indices = []
    for i in range((row - 1), (row + 2)):
        for j in range((column - 1), (column + 2)):
            if input_list[i][j].isdigit():
                numeric_indices.append((i,j))
    gear_nums[index_tuple] = numeric_indices

def num_range(index_tuple):
    row = index_tuple[0]
    left_index = index_tuple[1]
    right_index = index_tuple[1]
    while input_list[row][left_index - 1].isdigit():
        left_index -= 1
        if left_index < 0:
            break
    while input_list[row][right_index + 1].isdigit():
        right_index += 1
        if right_index > 138:
            break
    return (row, left_index, right_index)

special_indices = []
for i in range(140):
    for j in range(140):
        if input_list[i][j] == "*":
            special_indices.append((i, j))

for pair in special_indices:
    digit_check(pair)

gears = {}
for gear in gear_nums:
    triplets = []
    for num_index in gear_nums[gear]:
        triplets.append(num_range(num_index))
    triplet_set = set(triplets)
    triplet_list = list(triplet_set)
    if len(triplet_list) == 2:
        gears[gear] = triplet_list

total = 0
for gear in gears:
    cog1 = gears[gear][0]
    cog2 = gears[gear][1]
    cog1val = int(input_list[cog1[0]][cog1[1]:(cog1[2] + 1)])
    cog2val = int(input_list[cog2[0]][cog2[1]:(cog2[2] + 1)])
    ratio = cog1val * cog2val
    total += ratio
