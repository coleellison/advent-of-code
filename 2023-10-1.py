it = """FJ77.F7F.FF.F..7-J.7F|7-7-7-7FJJ-7J-LL-7FL.F-7.F-F77F7F7-77-F--7-FF|-F-L7-|.F7|7.F-77..-FF|--F.J7..|7FFL-JJ7-F-..J77.|FFJ77L---J7F7.J-F77JJ.
...
pos_list = []
current = [115, 41, "r"]
while next_index(current) != "found":
    pos_list.append([current[0], current[1]])
